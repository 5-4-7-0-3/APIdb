...
router.post('/',
  [
    ...
    check('login', "Login password must be more than 5 characters and less than 24").isLength({ min: 5, max: 24 }),
    check('password', "Password must be more than 5 characters and less than 24").isLength({ min: 5, max: 24 })
  ],
