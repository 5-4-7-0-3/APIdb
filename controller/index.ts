...
const userController = new UserController(services.userService, services.tokenService)
const salesController = new SalesController(services.salesService)
const productCategoryController = new ProductCategoryController(services.productCategoryService)
